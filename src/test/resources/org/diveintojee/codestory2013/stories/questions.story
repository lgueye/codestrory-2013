...
Narrative:
When the server is asked the a question
Then it should be able to answer correctly to that question

Scenario: the server should answer the right email
